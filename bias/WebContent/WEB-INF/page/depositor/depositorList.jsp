...
<body>
  <div class="panelBar" style=" border-width:1px;">
    <ul class="toolBar">
      <li><span style="margin-left:-25px;">当前位置：平台用户管理 >> 储户列表</span></li>
    </ul>
  </div>
  <div class="pageHeader">
    <form id="pagerForm" onsubmit="return navTabSearch(this);" action="${pageContext.request.contextPath}/page/depositor/search" method="post">
  ...
  <div class="pageContent">
    <div class="panelBar">
      <ul class="toolBar">
        <li><a class="add" href="${pageContext.request.contextPath}/page/depositor/add" target="dialog" rel="dialogid" resizable="false"  maxable="false" width="700" height="600"><span>添加社员</span></a></li>
        <li><a class="edit" href="${pageContext.request.contextPath}/page/depositor/edit/{id}" target="dialog" rel="dialogid" resizable="false"  maxable="false"  width="700" height="600"><span>修改社员</span></a></li>
        <li><a class="delete" postType="string" href="${pageContext.request.contextPath}/page/depositor/delete" target="selectedTodo" title="确定要删除吗"><span target="navTab">删除社员</span></a></li>
      </ul>
    </div>
    <div id="w_list_print">
      <table class="list" width="100%" layoutH="118">
        <thead>
          <tr height="25" style="text-align: center;">
            ...
            <th class="center">储户姓名</th>
            <th class="center">身份证号</th>
            <th class="center">储户编号</th>
            <th class="center">储户性别</th>
            <th class="center">信用等级</th>
            <th class="center">手机</th>
            <th class="center">介绍人</th>
        ...
        <c:forEach items="${paginationDTO.itemList}" var="depositor" varStatus="status">
          <tr style="text-align: center;"height="20" rel="${depositor.id}" target="id">
            ...
            <td>${depositor.creditLevel}</td>
            <td>${depositor.mobilePhone}</td>
            <td>${depositor.introducer}</td>
            <td>${depositor.orgId}</td>
            <td>${depositor.createdTime}</td>
            <td>${depositor.updatedTime}</td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
