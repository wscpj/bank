...
<html>
  ...
  <body style="background-repeat: no-repeat;background-position: center;background: url('${pageContext.request.contextPath}/Images/background.jpg');">
    <div class="panelBar" style=" border-width:1px;">
      <ul class="toolBar">
        <li><span style="margin-left:-25px;">当前位置：系统管理 >> 编辑管理员</span></li>
      </ul>
    </div>
    <div class="pageContent">
      <form method="post" action="${pageContext.request.contextPath}/page/user/update" class="pageForm required-validate"   onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="90">
          ...
          <p>
            <label>管理员密码：</label>
            <input name="password" class="required" type="password" size="30" value="${user.password }" alt="请输入管理员密码" />
          </p>
          <p>
            <label>管理员性别：</label>
          ...
          <p>
            ...
            <input name="email" class="required email" type="text" size="30" value="${user.email }" alt="请输入管理员邮箱" />
          </p>
          <p>
            <label>管理员手机：</label>
            <input name="phone" class="required phone" type="text" size="30"  value="${user.phone }" alt="请输入管理员手机号" />
          </p>
        </div>
        <div class="formBar">
          <ul>
